...
settings.PROJECT_PATH_MAP["hf_cache"] = {"directory": "hf_cache", "backup": False}
...
# ML Configurations
#
SENTENCE_PARSER_PROVIDERS = Config.list(
...
SUMMARIZER_COST_PER_TOKEN = Config.decimal(
    "ZIMAGI_SUMMARIZER_COST_PER_TOKEN", 0.0000003
)
